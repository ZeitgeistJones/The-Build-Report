...
export const NORMIE_SURFACE_SHAPES = {
  ...
  rescoreSummary:
    '1–2 short sentences. Warm friend texting. Lead with what landed in everyday words (no file paths, no ~/Desktop, no acronyms like TCC unless you explain them), then one soft score note. Never name rubric rows, never say Shipping leverage / +N pts, never dump commit titles (no fleet-health, per-VM, POOL, login dir). Translate the work into what a person would notice.',
  rubricSource:
