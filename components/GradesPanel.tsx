...
export default function GradesPanel({ builderGrade30, builderGrade7, holderGrade30, holderGrade7, stats30d, stats7d }: Props) {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '4px' }}>builder grade</div>
          </div>
          <div>
            ...
            {bg?.signals.map(s => (
              <div key={s.label} style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                ...
                <span style={{ fontSize: '10px', color: 'var(--text-muted)', width: '24px', textAlign: 'right' }}>
                  {s.level}
                </span>
              </div>
            ))}
            {stats && (
              <div style={{ marginTop: '10px', paddingTop: '10px', borderTop: '1px solid var(--border)', display: 'flex', gap: '16px' }}>
